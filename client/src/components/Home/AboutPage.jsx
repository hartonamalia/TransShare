  ...
  return (
    <div className="bg-gray-100 py-10">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl font-bold text-center mb-6">About TransShare</h1>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4">
            ...
            <ol className="list-decimal list-inside space-y-2">
              ...
              {/* <li>Leave Feedback: After the rental period, provide feedback on the renter to help build a trustworthy community.</li> */}
            </ol>
          </div>
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-semibold mb-4">Benefits of Using TransShare</h2>
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-semibold mb-4">Safety and Trust</h2>
